...
const HomePage = () => {
  return (
    <div className="flex flex-col text-foreground overflow-hidden min-h-screen">
      <section className="grow relative py-24 z-10">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 gap-8 items-center relative lg:grid-cols-12">
            {/* CORNER DECARATION */}
